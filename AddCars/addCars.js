...
<TouchableOpacity
                                    onPress={() => SaveCar()}
                                    style={{ flexDirection: 'row', justifyContent: 'center',backgroundColor:'orange',borderRadius:25,marginTop:15,width:'80%' }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ flexDirection: 'row', justifyContent: 'center',backgroundColor:'red',borderRadius:25,marginTop:15,width:'80%' }}>

                                    <Text style={styles.UploadDocument}>CANCEL</Text>
